...
const MUSIC_MAP: Dictionary = {
	Music.INTRO: preload("res://src/assets/audio/music/intro.mp3"),
	Music.MENU: preload("res://src/assets/audio/music/menu.mp3"),
	Music.STAGE1: preload("res://src/assets/audio/music/stage-01.mp3"),
	Music.STAGE2: preload("res://src/assets/audio/music/stage-02.mp3"),
}
